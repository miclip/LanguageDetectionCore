...
namespace Training
{
    class Program
    {
        static readonly string trainingDataFile = Path.Combine(Environment.CurrentDirectory, "Data", "training.tsv");
        static readonly string testDataFile = Path.Combine(Environment.CurrentDirectory, "Data", "test.tsv");
